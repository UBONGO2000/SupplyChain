...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "on_time_delivery_rate", sa.DECIMAL(precision=5, scale=2), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_suppliers_company_name"), "suppliers", ["company_name"], unique=False
    )
    op.create_index(
        op.f("ix_suppliers_country"), "suppliers", ["country"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("ADMIN", "MANAGER", "STAFF", "VIEWER", name="userrole"),
            nullable=False,
        ),
        sa.Column("is_active", sa.Boolean(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "current_utilization", sa.DECIMAL(precision=5, scale=2), nullable=True
        ),
        sa.Column("is_active", sa.Boolean(), nullable=True),
        sa.Column(
            "created_at", sa.TIMESTAMP(), server_default=sa.text("now()"), nullable=True
    ...
    op.create_table(
        ...
        sa.Column(
            "ordered_at", sa.TIMESTAMP(), server_default=sa.text("now()"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "category",
            sa.Enum(
                "ELECTRONICS", "FOOD", "TEXTILE", "INDUSTRIAL", name="productcategory"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "PENDING", "IN_TRANSIT", "DELIVERED", "CANCELLED", name="shipmentstatus"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_inventory_warehouse", "inventory", ["warehouse_id"], unique=False
    )
    op.create_table(
        "order_items",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        "idx_orderitem_product", "order_items", ["product_id"], unique=False
    )
