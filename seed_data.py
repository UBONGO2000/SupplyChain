...
def seed_demo_data() -> None:
    ...
    try:
        ...
        products = [
            ...
            models.Product(
                sku="ELEC-002",
                name="Ecran 27 pouces 4K",
                description="Moniteur IPS 4K 60Hz, USB-C",
                category=models.ProductCategory.ELECTRONICS,
                unit_price=349.00,
                weight_kg=5.400,
                dimensions_cm="62x40x8",
                reorder_point=8,
                reorder_quantity=20,
                supplier_id=tech.id,
            ),
            ...
            models.Product(
                ...
                supplier_id=indus.id,
            ),
            models.Product(
                sku="IND-002",
                name="Moteur electrique 1.5kW",
                description="Moteur triphase pour applications industrielles",
                category=models.ProductCategory.INDUSTRIAL,
                unit_price=245.00,
                weight_kg=18.000,
                dimensions_cm="35x25x25",
                reorder_point=5,
                reorder_quantity=15,
                supplier_id=indus.id,
            ),
        ...
        inventory_rows = [
            models.Inventory(
                warehouse_id=wh_paris.id,
                product_id=p["ELEC-001"].id,
                quantity=120,
                reserved_quantity=10,
                available_quantity=110,
                reorder_level=15,
                max_stock_level=300,
                location_in_warehouse="A1-03",
            ),
            models.Inventory(
                warehouse_id=wh_paris.id,
                product_id=p["ELEC-002"].id,
                quantity=18,
                reserved_quantity=2,
                available_quantity=16,
                reorder_level=8,
                max_stock_level=60,
                location_in_warehouse="A2-01",
            ),
            models.Inventory(
                warehouse_id=wh_paris.id,
                product_id=p["ELEC-004"].id,
                quantity=200,
                reserved_quantity=15,
                available_quantity=185,
                reorder_level=30,
                max_stock_level=500,
                location_in_warehouse="A1-07",
            ),
            models.Inventory(
                warehouse_id=wh_lyon.id,
                product_id=p["TEXT-001"].id,
                quantity=340,
                reserved_quantity=20,
                available_quantity=320,
                reorder_level=50,
                max_stock_level=800,
                location_in_warehouse="B3-02",
            ),
            models.Inventory(
                warehouse_id=wh_lyon.id,
                product_id=p["TEXT-002"].id,
                quantity=12,
                reserved_quantity=0,
                available_quantity=12,
                reorder_level=15,
                max_stock_level=100,
                location_in_warehouse="B3-05",
            ),
            models.Inventory(
                warehouse_id=wh_lyon.id,
                product_id=p["FOOD-001"].id,
                quantity=210,
            ...
            models.Inventory(
                warehouse_id=wh_toulouse.id,
                product_id=p["FOOD-002"].id,
                quantity=150,
                reserved_quantity=10,
                available_quantity=140,
                reorder_level=35,
                max_stock_level=400,
                location_in_warehouse="C2-04",
            ),
            models.Inventory(
                warehouse_id=wh_toulouse.id,
                product_id=p["IND-001"].id,
                quantity=40,
                reserved_quantity=0,
            ...
            models.Inventory(
                warehouse_id=wh_toulouse.id,
                product_id=p["IND-002"].id,
                quantity=3,
                reserved_quantity=1,
                available_quantity=2,
                reorder_level=5,
                max_stock_level=30,
                location_in_warehouse="D2-01",
            ),  # low stock
            models.Inventory(
                warehouse_id=wh_paris.id,
                product_id=p["ELEC-003"].id,
                quantity=75,
                reserved_quantity=5,
                available_quantity=70,
                reorder_level=20,
                max_stock_level=200,
                location_in_warehouse="A2-06",
            ),
        ]
        ...
        shipments = [
            models.Shipment(
                ...
                origin_warehouse_id=wh_paris.id,
                supplier_id=tech.id,
            ...
            models.Shipment(
                ...
                origin_warehouse_id=wh_lyon.id,
                supplier_id=textile.id,
            ...
            models.Shipment(
                ...
                origin_warehouse_id=wh_toulouse.id,
                supplier_id=indus.id,
        ...
        staff_user = (
            db.query(models.User).filter(models.User.username == "staff").first()
        )
